...
function App() {
  ...
  return (
    <div className="App">
      <div>
        <a href="src/0.getting-started/index.html" target="_blank">
          <h1>0.getting-started</h1>
        </a>
        <a href="src/1.displaying-work/index.html" target="_blank">
          <h1>1.displaying-work</h1>
        </a>
        <a href="src/2.knowing-state/index.html" target="_blank">
          <h1>2.knowing-state</h1>
        </a>
        <a href="src/3.recording-state/index.html" target="_blank">
          <h1>3.recording-state</h1>
        </a>
        <a href="src/4.points-in-3d/index.html" target="_blank">
          <h1>4.points-in-3d</h1>
        </a>
        <a href="src/5.tagging/index.html" target="_blank">
          <h1>5.tagging</h1>
        </a>
      </div>
